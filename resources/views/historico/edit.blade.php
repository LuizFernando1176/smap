    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header">Editar Historico #{{ $historico->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/historico/' . $historico->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
