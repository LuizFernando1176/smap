                                    ...
                                    <div class="panel profile-cover">
                                        ...
                                        <div class="profile-cover__img">
                                            ...
                                            <div class="profile-img-content text-dark text-start">
                                                <div class="text-dark">
                                                    <h3 class="h3 mb-2">{{Auth::user()->nome}}</h3>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3 mt-3">
                                ...
                                <div>
                                    <strong>Olinda, Pernambuco </strong>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3 mt-3">
                                <div class="me-4 text-center text-primary">
                                ...
                                <div>
                                    <strong>Responsável, Luiz Fernando</strong>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3 mt-3">
                                <div class="me-4 text-center text-primary">
                            ...
                            <div class="d-flex align-items-center mb-3 mt-3">
                                ...
                                <div>
                                    <strong>nando1176@hotmail.com </strong>
                                </div>
                            </div>
                        </div>
                    </div>
