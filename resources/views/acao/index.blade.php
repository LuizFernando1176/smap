        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-4">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/acao/create') }}" class="btn btn-success btn-sm"
                            title="{{ __('Add New') }} Acao">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $acao->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
